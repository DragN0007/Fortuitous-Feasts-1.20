...
public class DFFItems {
    ...
    public static final RegistryObject<Item> WHITE_BREAD = ITEMS.register("white_bread",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(1).effect(new MobEffectInstance(MobEffects.SATURATION, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> BANANA_BREAD = ITEMS.register("banana_bread",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(8).saturationMod(1).effect(new MobEffectInstance(MobEffects.SATURATION, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> NUT_BREAD = ITEMS.register("nut_bread",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(9).saturationMod(1).effect(new MobEffectInstance(MobEffects.SATURATION, 600, 0), 0.8F).build())));


    //Cookies
    public static final RegistryObject<Item> CHOCOLATE_CHIP_COOKIE = ITEMS.register("chocolate_chip_cookie",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(7).saturationMod(1).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> CRANBERRY_COOKIE = ITEMS.register("cranberry_cookie",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(8).saturationMod(1).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> DOUBLE_CHOCOLATE_CHIP_COOKIE = ITEMS.register("double_chocolate_chip_cookie",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(9).saturationMod(1).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> SUGAR_COOKIE = ITEMS.register("sugar_cookie",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(1).effect(new MobEffectInstance(MobEffects.DIG_SPEED, 600, 0), 0.8F).build())));


    //Meals
    public static final RegistryObject<Item> BLOOMING_ONION = ITEMS.register("blooming_onion",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(1).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> GARLIC_PARM_WINGS = ITEMS.register("garlic_parm_wings",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(8).saturationMod(1).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> VEGGIE_PLATTER = ITEMS.register("veggie_platter",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(12).saturationMod(1).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> VEGGIE_PASTA = ITEMS.register("veggie_pasta",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(8).saturationMod(1).effect(new MobEffectInstance(MobEffects.REGENERATION, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> DUMPLINGS = ITEMS.register("dumplings",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(12).saturationMod(1).effect(new MobEffectInstance(MobEffects.LUCK, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> CHICKEN_PARM = ITEMS.register("chicken_parm",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(16).saturationMod(1).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> MAC_N_CHEESE = ITEMS.register("mac_n_cheese",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(10).saturationMod(1).effect(new MobEffectInstance(MobEffects.REGENERATION, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> SAUSAGE_MAC = ITEMS.register("sausage_mac",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(16).saturationMod(1).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> SPAGHETTI = ITEMS.register("spaghetti",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(12).saturationMod(1).effect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> PEANUT_BUTTER_JELLY = ITEMS.register("peanut_butter_jelly",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(12).saturationMod(1).effect(new MobEffectInstance(MobEffects.REGENERATION, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> TOMATO_SOUP = ITEMS.register("tomato_soup",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(1).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> MERMAID_TOAST = ITEMS.register("mermaid_toast",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(12).saturationMod(1).effect(new MobEffectInstance(MobEffects.WATER_BREATHING, 600, 0), 0.8F).build())));
    public static final RegistryObject<Item> LASAGNA = ITEMS.register("lasagna",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(18).saturationMod(1).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 0), 0.8F).build())));

    //Pickled
    public static final RegistryObject<Item> PICKLES = ITEMS.register("pickles",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(12).saturationMod(1).effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> MEAT_CHEESE_WRAP = ITEMS.register("meat_cheese_wrap",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(10).saturationMod(1).effect(new MobEffectInstance(MobEffects.ABSORPTION, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> LYCHEE_PIE = ITEMS.register("lychee_pie",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(12).saturationMod(1).effect(new MobEffectInstance(MobEffects.SATURATION, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> PLAIN_DONUT = ITEMS.register("plain_donut",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(1).effect(new MobEffectInstance(MobEffects.HEAL, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> LYCHEE_SMOOTHIE = ITEMS.register("lychee_smoothie",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(1).effect(new MobEffectInstance(MobEffects.REGENERATION, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> CHOCOLATE_CAKE = ITEMS.register("chocolate_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.CHOCOLATE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> YELLOW_CHOCOLATE_CAKE = ITEMS.register("yellow_chocolate_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.YELLOW_CHOCOLATE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> CHERRY_CHOCOLATE_CAKE = ITEMS.register("cherry_chocolate_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.CHERRY_CHOCOLATE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> RED_VELVET_CAKE = ITEMS.register("red_velvet_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.RED_VELVET_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> WHITE_CAKE = ITEMS.register("white_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.WHITE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> LYCHEE_CAKE = ITEMS.register("lychee_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.LYCHEE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> MANGO_CAKE = ITEMS.register("mango_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.MANGO_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> ORANGE_CAKE = ITEMS.register("orange_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.ORANGE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> PEAR_CAKE = ITEMS.register("pear_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.PEAR_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> POMEGRANATE_CAKE = ITEMS.register("pomegranate_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.POMEGRANATE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> RASPBERRY_CAKE = ITEMS.register("raspberry_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.RASPBERRY_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> RED_GRAPE_CAKE = ITEMS.register("red_grape_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.RED_GRAPE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> PURPLE_GRAPE_CAKE = ITEMS.register("purple_grape_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.PURPLE_GRAPE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> STRAWBERRY_CAKE = ITEMS.register("strawberry_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.STRAWBERRY_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> WHITE_RASPBERRY_CAKE = ITEMS.register("white_raspberry_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.WHITE_RASPBERRY_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> BLACKBERRY_CAKE = ITEMS.register("blackberry_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.BLACKBERRY_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> BLUEBERRY_CAKE = ITEMS.register("blueberry_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.BLUEBERRY_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> CHERRY_CAKE = ITEMS.register("cherry_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.CHERRY_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> CRANBERRY_CAKE = ITEMS.register("cranberry_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.CRANBERRY_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> GRAPEFRUIT_CAKE = ITEMS.register("grapefruit_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.GRAPEFRUIT_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> GREEN_GRAPE_CAKE = ITEMS.register("green_grape_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.GREEN_GRAPE_CAKE.get(), (new Item.Properties())));
    public static final RegistryObject<Item> KIWI_CAKE = ITEMS.register("kiwi_cake",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.KIWI_CAKE.get(), (new Item.Properties())));

    //Jam
    public static final RegistryObject<Item> LYCHEE_JAM = ITEMS.register("lychee_jam",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> LYCHEE_SODA = ITEMS.register("lychee_soda",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationMod(1).effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> LYCHEE_PASTRY = ITEMS.register("lychee_pastry",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(7).saturationMod(1).effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> BEEF_SAUSAGE = ITEMS.register("beef_sausage",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationMod(1).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> CHEDDAR_CHEESE = ITEMS.register("cheddar_cheese",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(1).effect(new MobEffectInstance(MobEffects.LUCK, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> DRIED_LYCHEE = ITEMS.register("dried_lychee",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(1).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 600, 0), 0.8F).build())));
    ...
    public static final RegistryObject<Item> BELL_PEPPER = ITEMS.register("bell_pepper",
            () -> new ItemNameBlockItem(DFFBlocks.BELL_PEPPER_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationMod(1).build()))));
    public static final RegistryObject<Item> BLACKBERRY = ITEMS.register("blackberry",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.BLACKBERRY_BUSH.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> BLACK_BEANS = ITEMS.register("black_beans",
            () -> new ItemNameBlockItem(DFFBlocks.BLACK_BEAN_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> BLUEBERRIES = ITEMS.register("blueberries",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.BLUEBERRY_BUSH.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> BRUSSELS_SPROUTS = ITEMS.register("brussels_sprouts",
            () -> new ItemNameBlockItem(DFFBlocks.BRUSSELS_SPROUTS_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationMod(1).build()))));
    public static final RegistryObject<Item> BUTTERNUT_SQUASH = ITEMS.register("butternut_squash",
            () -> new ItemNameBlockItem(DFFBlocks.BUTTERNUT_SQUASH_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationMod(1).build()))));
    public static final RegistryObject<Item> CELERY = ITEMS.register("celery",
            () -> new ItemNameBlockItem(DFFBlocks.CELERY_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationMod(1).build()))));
    ...
    public static final RegistryObject<Item> CHILI_PEPPER = ITEMS.register("chili_pepper",
            () -> new ItemNameBlockItem(DFFBlocks.CHILI_PEPPER_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationMod(1).build()))));
    public static final RegistryObject<Item> COCONUT = ITEMS.register("coconut",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_COCONUT_SAPLING.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationMod(1).build()))));
    public static final RegistryObject<Item> CORN = ITEMS.register("corn",
            () -> new ItemNameBlockItem(DFFBlocks.CORN_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(1).build()))));
    public static final RegistryObject<Item> CRANBERRIES = ITEMS.register("cranberries",
            () -> new ItemNameBlockItem(DFFBlocks.CRANBERRY_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> CUCUMBER = ITEMS.register("cucumber",
            () -> new ItemNameBlockItem(DFFBlocks.CUCUMBER_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> GARLIC = ITEMS.register("garlic",
            () -> new ItemNameBlockItem(DFFBlocks.GARLIC_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    ...
    public static final RegistryObject<Item> PURPLE_GRAPES = ITEMS.register("purple_grapes",
            () -> new ItemNameBlockItem(DFFBlocks.PURPLE_GRAPE_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> RED_GRAPES = ITEMS.register("red_grapes",
            () -> new ItemNameBlockItem(DFFBlocks.RED_GRAPE_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> WHITE_GRAPES = ITEMS.register("white_grapes",
            () -> new ItemNameBlockItem(DFFBlocks.WHITE_GRAPE_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> GREEN_BEANS = ITEMS.register("green_beans",
            () -> new ItemNameBlockItem(DFFBlocks.GREEN_BEAN_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> GINGER = ITEMS.register("ginger",
            () -> new ItemNameBlockItem(DFFBlocks.GINGER_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(1).build()))));
    public static final RegistryObject<Item> JALEPENO_PEPPER = ITEMS.register("jalepeno_pepper",
            () -> new ItemNameBlockItem(DFFBlocks.JALEPENO_PEPPER_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> KIDNEY_BEANS = ITEMS.register("kidney_beans",
            () -> new ItemNameBlockItem(DFFBlocks.KIDNEY_BEAN_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    ...
    public static final RegistryObject<Item> ONION = ITEMS.register("onion",
            () -> new ItemNameBlockItem(DFFBlocks.ONION_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(1).build()))));
    ...
    public static final RegistryObject<Item> PEANUTS = ITEMS.register("peanuts",
            () -> new ItemNameBlockItem(DFFBlocks.PEANUT_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    ...
    public static final RegistryObject<Item> RADISH = ITEMS.register("radish",
            () -> new ItemNameBlockItem(DFFBlocks.RADISH_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> RASPBERRY = ITEMS.register("raspberry",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.RASPBERRY_BUSH.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> WHITE_RASPBERRY = ITEMS.register("white_raspberry",
            () -> new ItemNameBlockItem(DFFBlocksNoDatagen.WHITE_RASPBERRY_BUSH.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> RYE = ITEMS.register("rye",
            () -> new ItemNameBlockItem(DFFBlocks.RYE_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationMod(1).build()))));
    public static final RegistryObject<Item> SOYBEANS = ITEMS.register("soybeans",
            () -> new ItemNameBlockItem(DFFBlocks.SOYBEAN_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> STRAWBERRY = ITEMS.register("strawberry",
            () -> new ItemNameBlockItem(DFFBlocks.STRAWBERRY_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> SUGAR_BEET = ITEMS.register("sugar_beet",
            () -> new ItemNameBlockItem(DFFBlocks.SUGAR_BEET_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> TOMATO = ITEMS.register("tomato",
            () -> new ItemNameBlockItem(DFFBlocks.TOMATO_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationMod(1).build()))));
    public static final RegistryObject<Item> ZUCCHINI = ITEMS.register("zucchini",
            () -> new ItemNameBlockItem(DFFBlocks.ZUCCHINI_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    ...
    public static final RegistryObject<Item> CASHEWS = ITEMS.register("cashews",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_CASHEW_SAPLING.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> OLIVES = ITEMS.register("olives",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_OLIVE_SAPLING.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> WALNUT = ITEMS.register("walnut",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_WALNUT_SAPLING.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));
    public static final RegistryObject<Item> ALMONDS = ITEMS.register("almonds",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_ALMOND_SAPLING.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationMod(1).build()))));

    // Herbs
    public static final RegistryObject<Item> CILANTRO = ITEMS.register("cilantro",
            () -> new ItemNameBlockItem(DFFBlocks.CILANTRO_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationMod(1).build()))));
    public static final RegistryObject<Item> MINT = ITEMS.register("mint",
            () -> new ItemNameBlockItem(DFFBlocks.MINT_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationMod(1).build()))));
    public static final RegistryObject<Item> OREGANO = ITEMS.register("oregano",
            () -> new ItemNameBlockItem(DFFBlocks.OREGANO_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationMod(1).build()))));
    public static final RegistryObject<Item> ROSEMARY = ITEMS.register("rosemary",
            () -> new ItemNameBlockItem(DFFBlocks.ROSEMARY_PLANT.get(), (new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationMod(1).build()))));


    //TODO; Seeds
    public static final RegistryObject<Item> ORANGE_SEEDS = ITEMS.register("orange_seeds",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_ORANGE_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> GRAPEFRUIT_SEEDS = ITEMS.register("grapefruit_seeds",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_GRAPEFRUIT_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> MANGO_SEED = ITEMS.register("mango_seed",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_MANGO_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> AVOCADO_PIT = ITEMS.register("avocado_pit",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_AVOCADO_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> KIWI_SEEDS = ITEMS.register("kiwi_seeds",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_KIWI_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> PEAR_SEEDS = ITEMS.register("pear_seeds",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_PEAR_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> LYCHEE_SEED = ITEMS.register("lychee_seed",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_LYCHEE_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> CHERRY_PIT = ITEMS.register("cherry_pit",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_CHERRY_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> POMEGRANATE_SEEDS = ITEMS.register("pomegranate_seeds",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_POMEGRANATE_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> BANANA_SEEDS = ITEMS.register("banana_seeds",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_BANANA_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> DRAGONFRUIT_SEEDS = ITEMS.register("dragonfruit_seeds",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_DRAGONFRUIT_SAPLING.get(), (new Item.Properties())));
    public static final RegistryObject<Item> PASSIONFRUIT_SEEDS = ITEMS.register("passionfruit_seeds",
            () -> new ItemNameBlockItem(DFFBlocks.DFF_PASSIONFRUIT_SAPLING.get(), (new Item.Properties())));
